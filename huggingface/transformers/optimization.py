...
def get_epoch_step_schedule(optimizer, steps_per_epoch, num_train_epochs, gamma=0.1, last_epoch=-1):
    return MultiStepLR(optimizer, milestones=range(steps_per_epoch, num_train_epochs*steps_per_epoch, steps_per_epoch), gamma=gamma, last_epoch=last_epoch)


TYPE_TO_SCHEDULER_FUNCTION = {
    SchedulerType.EPOCH_STEP: get_epoch_step_schedule,
...
def get_scheduler(
    ...
    if name == SchedulerType.EPOCH_STEP:
        return schedule_func(optimizer, steps_per_epoch, num_train_epochs)

...
# Note: if you intend to run this script make sure you look under old_scripts/fsmt/
# to locate the appropriate script to do the work correctly. There is a set of old_scripts to:
